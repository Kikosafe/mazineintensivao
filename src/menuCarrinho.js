...
function incrementarQauntidadeProduto(idProduto) {
    ...
    salvarLocalStorage('carrinho', idsProdutoCarrinhoComQuantidade);
    atualizarPrecoCarrinho();
    autalizarInformacaoQuantidade(idProduto);
}
...
function autalizarInformacaoQuantidade(idProduto) {
...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    const containerProdutosCarrinho = document.getElementById("produtos-carrinhos");
    ...
    const cartaoProdutoCarrinho = `<button id="remover-item-${produto.id}" class="absolute top-0 right-2">
        <i class="fa-solid fa-circle-xmark text-slate-700 hover:text-slate-800"></i>
        </button>
...
export function renderizarProdutosCarrinho() {
    ...
    document.getElementById("produtos-carrinhos");
